...
# From https://github.com/billimek/k8s-gitops/blob/master/setup/bootstrap-cluster.sh
...
installFlux() {
  ...
  flux bootstrap github --token-auth --owner=andyopengit --repository=home_sys --branch master --personal --network-policy=false --path=kubernetes
